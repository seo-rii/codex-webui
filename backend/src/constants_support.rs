...
pub(crate) const AUTH_REVOKED_SESSION_MAX_ENTRIES: usize = 8192;
...
pub(crate) const INFLIGHT_REQUEST_TTL: Duration = Duration::from_secs(60);
pub(crate) const INFLIGHT_REQUEST_MAX_ENTRIES: usize = 4096;
pub(crate) const INFLIGHT_REQUEST_MAX_WAITERS: usize = 64;
...
pub(crate) const QUOTA_CACHE_TTL: Duration = Duration::from_secs(2 * 60);
pub(crate) const QUOTA_FORCE_MIN_REFRESH_INTERVAL: Duration = Duration::from_secs(30);
pub(crate) const CATALOG_CACHE_TTL: Duration = Duration::from_secs(10);
pub(crate) const CATALOG_CACHE_MAX_ENTRIES: usize = 64;
