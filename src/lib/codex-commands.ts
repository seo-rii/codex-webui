...
export const CODEX_SLASH_COMMANDS: CodexSlashCommandEntry[] = [
  ...
  { command: "apps", description: "Manage apps.", support: "app-server-proxied", source: "upstream", inlineArgs: false, visibleInComposer: true },
  ...
  { command: "realtime", description: "Toggle realtime voice mode.", support: "app-server-proxied", source: "upstream", inlineArgs: true, visibleInComposer: true },
